...
namespace EDSDKLib
{
    public class SDKHandler : IDisposable
    {
        ...
        /// <summary>
        /// filename where photo will be saved 
        /// </summary>
        ...
        public void CloseSession()
        {
            if (CameraSessionOpen)
            {
                ...
                lock (LVlock)
                {
                    ...
                    MainCamera.Ref = System.IntPtr.Zero;
        ...
        private uint Camera_SDKObjectEvent(uint inEvent, IntPtr inRef, IntPtr inContext)
        {
            ...
            switch (inEvent)
            {
                ...
                case EDSDK.ObjectEvent_DirItemRequestTransfer:
                    DownloadImage(inRef, ImageSaveDirectory, ImageSaveName);
                    break;
        ...
        public void DownloadImage(IntPtr ObjectPointer, string directory, string fileName="")
        {
            lock (LVlock)
            {
                ...
                if (fileName.Length > 0)
                    CurrentPhoto = Path.Combine(directory, fileName);
                else
